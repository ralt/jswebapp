...
require.define("/dummy.js", Function(
    [ 'require', 'module', 'exports', '__dirname', '__filename' ],
    "(function () { \nvar Core = Object.create(nCore).constructor()\ndelete window.nCore \nCore.use('foo', require('./foo.js')) \nCore.use('bar.foo', require('./bar/foo.js')) \nCore.use('bar.bar', require('./bar/bar.js')) \nCore.dependencies = {\"foo\":{\"bar\":\"bar.bar\",\"foo\":\"bar.foo\"},\"bar.foo\":{\"foo\":\"foo\",\"foobar\":\"bar.foo\",\"bars\":{\"foo\":\"bar.foo\",\"bar\":\"bar.bar\"}},\"bar.bar\":{\"foo\":\"foo\",\"foobar\":\"bar.bar\",\"bars\":{\"foo\":\"bar.foo\",\"bar\":\"bar.bar\"}}}\nCore.init()\n})()\n//@ sourceURL=/dummy.js"
));
require("/dummy.js");
